...
10. ✅ **统一业务主线**：模块说明需映射到真实场景。课程采用**双主线并行**设计：主线1「电商客服智能助理」（文本/NLP, M1-M9）、主线2「通用多模态平台」（视觉/多模态, M10 及 M05/M07/M08 穿插点）
...
1. 📚 本章概览 (Overview)
   - 学习目标（3-5 个明确目标）
   - 核心问题（要解决的关键问题）
   - 🏢 业务场景（NLP 模块锚定到电商客服智能助理，多模态模块锚定到通用多模态平台，2-4 句）
   - 知识地图（本章在整体课程中的位置）
   - 预计学习时间
...
- [ ] 是否明确映射统一业务主线（NLP 主线：电商客服智能助理 / 多模态主线：通用多模态平台）？
- [ ] 是否包含”可交付产出”（2-3 个）？
...
2. 映射统一业务主线（NLP 主线：电商客服智能助理 / 多模态主线：通用多模态平台）
3. 确定学习目标（3-6 个）
4. 定义可交付产出与最低完成标准
5. 列出核心概念与实践项目
6. 估算学习时间与学习曲线分段
...
- 统一业务主线映射（NLP 主线：电商客服智能助理 / 多模态主线：通用多模态平台）
