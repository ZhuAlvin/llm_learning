...
- “商品图片分类模型也要微调，能用同一套 LoRA 方法吗？” -> LoRA for ViT（M10 便利店货架案例中用于 ViT 商品分类器的店级微调，详见 Module 10.4）
...
> 🎥 **多模态视角**：LoRA 在 M10 便利店货架案例中用于 ViT 商品分类器的店级微调（50 张图/店），含多分支管理和增量类别学习，详见 **Module 10.4: 场景微调与边缘部署**。
...
- **Module 10**: 多模态小模型应用（LoRA for ViT 店级微调、便利店货架监控）
